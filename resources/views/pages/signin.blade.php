...
@section('title', 'Sign In - RecruitSy')
...
<div class="auth-container">
    <div class="auth-card">
        <div class="auth-header">
            ...
            <p class="auth-subtitle">Sign in to your account to continue your job search</p>
        </div>

        <form class="auth-form" action="{{ route('signin.post') }}" method="POST">
            @csrf
            ...
            <div class="form-options">
                ...
                <a href="#" class="forgot-link">Forgot password?</a>
                            ...
                            <button type="submit" class="btn btn-primary btn-lg auth-btn">Sign In</button>
            @if ($errors->any())
